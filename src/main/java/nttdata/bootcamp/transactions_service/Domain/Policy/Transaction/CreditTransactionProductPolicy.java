...
/**
 * {@link TransactionProductPolicy} for generic credit line products.
 */
@Component
@RequiredArgsConstructor
public class CreditTransactionProductPolicy implements TransactionProductPolicy {
    ...
    public Mono<TransactionDocument> prepareDocument(TransactionRequest request) {
        return creditClient.getCreditById(request.getProductId())
                ...
                .flatMap(credit -> processCreditByTransactionType(credit, request, false));
    }
